...
function affichageModal2() {
  ...
  /**
   * Gestion du formulaire d'ajout photo et Ajout Photo
   */
  ...
  if (boutonValiderAjoutPhoto) {
    ...
    if (inputTitre.value.trim() !== "" && selectCategorie.value !== "" && fileInput.files.length > 0) {
      boutonValiderAjoutPhoto.disabled = false;
      
    console.log(selectCategorie.id)
    console.log(selectCategorie.value)
    console.log(inputTitre.value.trim())
    }
  else{
